        ...
        <div class="bg-white" style="width:500px">
            ...
            <div class="bg-white p-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="gender" name="gender" value="<?php echo e($user->gender); ?>" disabled>
                </div>
                <div class="mb-3">
                    <label for="dateOfBirth" class="form-label fw-normal">Date of Birth</label>
                    <input type="text" class="form-control" id="dateOfBirth" name="dateOfBirth" value="<?php echo e($user->date_of_birth); ?>" disabled>
                </div>
                <div class="mb-3">
                    <label for="country" class="form-label fw-normal">Country</label>
                    <input type="text" class="form-control" id="country" name="country" value="<?php echo e($user->country->country_name); ?>" disabled>
                </div>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH E:\BINUS\Semester 5\Web Programming\Barbatos Shop\barbatoshop\resources\views/profile.blade.php ENDPATH**/ ?>