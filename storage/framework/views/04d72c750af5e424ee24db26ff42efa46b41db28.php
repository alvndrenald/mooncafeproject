        ...
        <div style="width: 780px">
            <?php $__empty_1 = true; $__currentLoopData = $cartDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cartDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="d-flex bg-white w-100 mb-3">
                    <img style="width:180px; height: 180px; object-fit: cover" src="<?php echo e($cartDetail->product->image); ?>"
                        alt="Card image cap">
                    <div class="d-flex justify-content-between w-100 p-3">
                        ...
                        <div>
                            <form
                                action="<?php echo e(route('cart-detail.destroy', ['cart' => $cart->id, 'product' => $cartDetail->product->id])); ?>"
                                method="POST">
...
<?php endif; ?>
<?php /**PATH E:\BINUS\Semester 5\Web Programming\Barbatos Shop\barbatoshop\resources\views/cart/index.blade.php ENDPATH**/ ?>