...
unset($__errorArgs, $__bag); ?>"
                            placeholder="Enter Your Name" name="name" value="<?php echo e(old('name')); ?>" required>
                        <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="mt-2 text-danger"><span class="fw-medium">Oops! </span><?php echo e($message); ?>
...
unset($__errorArgs, $__bag); ?>" name="password"
                            placeholder="Enter Your Password" value="<?php echo e(old('password')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="confirm-password"
                            placeholder="Re-type Your Password" value="<?php echo e(old('confirm-password')); ?>"required>
...
unset($__errorArgs, $__bag); ?>" id="country" name="country">
                            ...
                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($country->id); ?>"
                                    <?php echo e($country->id == old('country') ? 'selected' : ''); ?>>
...
<?php endif; ?>
<?php /**PATH E:\BINUS\Semester 5\Web Programming\BS\bs\resources\views/auth/register.blade.php ENDPATH**/ ?>