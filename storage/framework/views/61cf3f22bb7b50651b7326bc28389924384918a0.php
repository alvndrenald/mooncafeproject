    ...
    <div class="d-flex justify-content-center align-items-center container">
        <div class="d-flex gap-4 px-2 align-items-center bg-white mt-5" style="width:800px; height:350px;">
            ...
            <form action="<?php echo e(route('cart.store')); ?>" method="POST">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <button class="btn btn btn-outline-secondary mt-2" type="submit">Add To Cart</button>
                <?php endif; ?>
            </form>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH E:\BINUS\Semester 5\Web Programming\Moon Cafe Project\mooncafe\resources\views/products/show.blade.php ENDPATH**/ ?>