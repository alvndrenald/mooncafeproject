...
<?php $component->withAttributes([]); ?>
    <div class="d-flex justify-content-center align-items-center container">
        <div class="d-flex gap-4 px-2 align-items-center bg-white mt-5" style="width:800px; height:350px;">
            <img style="width:200px; height:200px; object-fit: cover" class="img-thumbnail" src="<?php echo e($product->image); ?>"
                alt="Card image cap">
...
<?php endif; ?>
<?php /**PATH E:\BINUS\Semester 5\Web Programming\BS\bs\resources\views/products/show.blade.php ENDPATH**/ ?>