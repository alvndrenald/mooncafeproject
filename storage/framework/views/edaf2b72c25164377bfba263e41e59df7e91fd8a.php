                ...
                <div class="w-full bg-white mt-4">
                    <div style="background-color : rgb(247, 247, 247); height:40px;"
                        ...
                        <?php echo e($category->category_name); ?> &nbsp;<a
                            href="<?php echo e(route('products.index', 'category=' . $category->category_name)); ?>"
                                ...
                                <div class="p-3">
                                    <div class="border border-2 p-3" style="width: 220px; height: 330px">
                                        <img style="width:220px; height: 220px; object-fit: cover" class="img-thumbnail"
                                            src="<?php echo e(url('image')); ?>/<?php echo e($product->image); ?>" alt="Card image cap">
                                        <div class="p-2">
                                            <div class="fw-medium">
...
<?php endif; ?>
<?php /**PATH E:\BINUS\Semester 5\Web Programming\BS\bs\resources\views/index.blade.php ENDPATH**/ ?>