        ...
        <div style="width: 780px">
            @forelse ($cartDetails as $cartDetail)
                <div class="d-flex bg-white w-100 mb-3">
                    <img style="width:180px; height: 180px; object-fit: cover" src="{{ $cartDetail->product->image }}" alt="Card image cap">
                    <div class="d-flex justify-content-between w-100 p-3">
                        ...
                        <div>
                            <form action="{{ route('cart-detail.destroy', ['cart' => $cart->id, 'product' => $cartDetail->product->id]) }}" method="POST">
                                @method('delete')
                                @csrf
